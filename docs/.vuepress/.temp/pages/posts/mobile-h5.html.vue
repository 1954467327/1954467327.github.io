<template><div><h1 id="移动h5部署" tabindex="-1"><a class="header-anchor" href="#移动h5部署"><span>移动H5部署</span></a></h1>
<p>提示：H5 包已经集成在 kb 包中，只需要修改相关配置文件。</p>
<h2 id="_1-挂载目录查看" tabindex="-1"><a class="header-anchor" href="#_1-挂载目录查看"><span>1.挂载目录查看</span></a></h2>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">cat</span> /etc/LeagView.conf</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-配置前端h5配置文件" tabindex="-1"><a class="header-anchor" href="#_2-配置前端h5配置文件"><span>2.配置前端H5配置文件</span></a></h2>
<p>复制配置文件并进行修改</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>配置h5-pro，配置此参数需要在地址栏带上审批员，例如 ehr=审批员</p>
<p><img src="https://cdn.nlark.com/yuque/0/2025/png/40933698/1744803181179-d28d1d5c-02a5-4506-bee6-5972368d0fa1.png" alt=""></p>
<h2 id="_3-修改nginx配置-并重启nginx配置" tabindex="-1"><a class="header-anchor" href="#_3-修改nginx配置-并重启nginx配置"><span>3.修改nginx配置，并重启nginx配置</span></a></h2>
...
<h2 id="_4-访问h5前端页面" tabindex="-1"><a class="header-anchor" href="#_4-访问h5前端页面"><span>4.访问H5前端页面</span></a></h2>
<p>需要结合场景判断是否需要开启密码登录：<font style="color:#DF2A3F;">InterfacePwdCheck=true</font>
目前只有emm支持账号密码登录</p>
...
<h2 id="_5-部署wms-开启h5预览功能" tabindex="-1"><a class="header-anchor" href="#_5-部署wms-开启h5预览功能"><span>5.部署WMS，开启H5预览功能</span></a></h2>
<p>1.下载WMS包：
<a href="http://10.8.98.22:8888/develop/20250630SP.41/" target="_blank" rel="noopener noreferrer">http://10.8.98.22:8888/develop/20250630SP.41/</a></p>
<!-- 这是一张图片，ocr 内容为： -->
...
<p>3.wms服务器设置白名单，独立部署:只用预览，可以配置白名单，新增xsource.dat加入ip，修改要重启docker，多个ip用分号隔开
在服务器/hhh/hdata下面的三个目录新增文件xsource.dat，把需要访问的ip加入文件中，多个ip用分号隔开。</p>
<!-- 这是一张图片，ocr 内容为： -->
