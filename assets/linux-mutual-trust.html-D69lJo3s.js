...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-批量互信检测脚本" tabindex="-1"><a class="header-anchor" href="#_5-批量互信检测脚本"><span>5. 批量互信检测脚本</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">#!/bin/bash</span>
<span class="line"># check_ssh_trust.sh</span>
<span class="line"></span>
<span class="line"># 配置</span>
<span class="line">USER=&quot;root&quot;                    # SSH用户</span>
<span class="line">SSH_PORT=&quot;22&quot;                  # SSH端口</span>
<span class="line">TIMEOUT=5                      # 连接超时时间(秒)</span>
<span class="line">SSH_OPTIONS=&quot;-o ConnectTimeout=$TIMEOUT -o BatchMode=yes -o StrictHostKeyChecking=no&quot;</span>
<span class="line"></span>
<span class="line"># 主机列表</span>
<span class="line">HOSTS=(</span>
<span class="line">    &quot;192.168.1.101&quot;</span>
<span class="line">    &quot;192.168.1.102&quot;</span>
<span class="line">    &quot;192.168.1.103&quot;</span>
<span class="line">    &quot;192.168.1.104&quot;</span>
<span class="line">    &quot;192.168.1.105&quot;</span>
<span class="line">)</span>
<span class="line"></span>
<span class="line"># 颜色定义</span>
<span class="line">RED=&#39;\\033[0;31m&#39;</span>
<span class="line">GREEN=&#39;\\033[0;32m&#39;</span>
<span class="line">YELLOW=&#39;\\033[1;33m&#39;</span>
<span class="line">BLUE=&#39;\\033[0;34m&#39;</span>
<span class="line">NC=&#39;\\033[0m&#39; # No Color</span>
<span class="line"></span>
<span class="line">echo -e &quot;\${BLUE}=== SSH互信检测脚本 ===\${NC}&quot;</span>
<span class="line">echo -e &quot;当前主机: $(hostname)&quot;</span>
<span class="line">echo -e &quot;检测用户: $USER&quot;</span>
<span class="line">echo -e &quot;SSH端口: $SSH_PORT&quot;</span>
<span class="line"></span>
<span class="line"># 检测本机到各节点的互信</span>
<span class="line">echo -e &quot;\\n\${YELLOW}[1] 检测本机到各节点的互信:\${NC}&quot;</span>
<span class="line">for host in &quot;\${HOSTS[@]}&quot;; do</span>
<span class="line">    echo -n &quot;检测 $USER@$host ... &quot;</span>
<span class="line">    </span>
<span class="line">    if ssh $SSH_OPTIONS -p $SSH_PORT $USER@$host &quot;echo &#39;SSH信任检测成功&#39;&quot; &amp;&gt;/dev/null; then</span>
<span class="line">        echo -e &quot;\${GREEN}✓ 信任\${NC}&quot;</span>
<span class="line">    else</span>
<span class="line">        echo -e &quot;\${RED}✗ 不信任\${NC}&quot;</span>
<span class="line">    fi</span>
<span class="line">done</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,25)])])}const o=n(i,[["render",p]]),r=JSON.parse(`{"path":"/posts/linux-mutual-trust.html","title":"Linux互信","lang":"zh-CN","frontmatter":{"lang":"zh-CN","title":"Linux互信","description":"此文档介绍互信的原理，并提供批量互信脚本支持一键对多个服务器进行单向互信，服务器密码可以使用统一密码也可以使用自定义密码","date":"2026-01-21T00:00:00.000Z","category":["Linux"],"tag":["互信"]},"headers":[{"level":2,"title":"1. 互信原理","slug":"_1-互信原理","link":"#_1-互信原理","children":[{"level":3,"title":"1.1 SSH公钥认证机制","slug":"_1-1-ssh公钥认证机制","link":"#_1-1-ssh公钥认证机制","children":[]},{"level":3,"title":"1.2 工作流程","slug":"_1-2-工作流程","link":"#_1-2-工作流程","children":[]},{"level":3,"title":"1.3 互信类型","slug":"_1-3-互信类型","link":"#_1-3-互信类型","children":[]}]},{"level":2,"title":"2. 互信的步骤","slug":"_2-互信的步骤","link":"#_2-互信的步骤","children":[{"level":3,"title":"1.1 生成本地密钥","slug":"_1-1-生成本地密钥","link":"#_1-1-生成本地密钥","children":[]},{"level":3,"title":"1.2 分发公钥到目标服务器","slug":"_1-2-分发公钥到目标服务器","link":"#_1-2-分发公钥到目标服务器","children":[]}]},{"level":2,"title":"3. 互信失败检测","slug":"_3-互信失败检测","link":"#_3-互信失败检测","children":[{"level":3,"title":"3.1 客户端权限","slug":"_3-1-客户端权限","link":"#_3-1-客户端权限","children":[]},{"level":3,"title":"3.2 服务端权限","slug":"_3-2-服务端权限","link":"#_3-2-服务端权限","children":[]}]},{"level":2,"title":"4. 批量互信脚本","slug":"_4-批量互信脚本","link":"#_4-批量互信脚本","children":[]},{"level":2,"title":"5. 批量互信检测脚本","slug":"_5-批量互信检测脚本","link":"#_5-批量互信检测脚本","children":[]}],"git":{"updatedTime":1775475490000,"contributors":[{"name":"litong","username":"litong","email":"1954467327@qq.com","commits":1,"url":"https://github.com/litong"}],"changelog":[{"hash":"0ac2f0903ba8334e9d63b2cca1ece4b3622f0025","time":1775475490000,"email":"1954467327@qq.com","author":"litong","message":"Merge remote-tracking branch 'master/main'"}]},"filePathRelative":"posts/linux-mutual-trust.md","excerpt":"\\n<p>此文档介绍互信的原理，并提供批量互信脚本支持一键对多个服务器进行单向互信，服务器密码可以使用统一密码也可以使用自定义密码</p>\\n<h2>1. 互信原理</h2>\\n<h3>1.1 SSH公钥认证机制</h3>\\n<ul>\\n<li>Linux互信基于SSH协议的公钥认证机制，其核心原理是：</li>\\n<li>非对称加密：使用RSA或ED25519等算法生成公钥-私钥对</li>\\n<li>身份验证：客户端用私钥签名，服务端用公钥验证签名</li>\\n<li>免密登录：验证成功后无需输入密码即可建立SSH连接</li>\\n</ul>\\n<h3>1.2 工作流程</h3>\\n<ol>\\n<li>客户端发起SSH连接请求</li>\\n<li>服务端返回随机字符串(challenge)</li>\\n<li>客户端用私钥对字符串进行数字签名</li>\\n<li>服务端用存储的公钥验证签名</li>\\n<li>验证通过 → 建立连接；验证失败 → 要求密码认证</li>\\n</ol>"}`);export{o as comp,r as data};
